...
export const cpaTransactionCodeCategoryProvincialLocal: CPACodeCategory = {
  cpaCodeMin: '600',
  cpaCodeMax: '620',
  cpaCodeCategory: 'Provincial and Local Government Transactions'
}

export const cpaTransactionCodesProvincialLocal: Record<CPACodeString, CPACode> = {
  600: {
