...
export const cpaTransactionCodeCategoryPreauthorized: CPACodeCategory = {
  cpaCodeMin: '200',
  cpaCodeMax: '229',
  cpaCodeCategory: 'Pre-Authorized Transactions'
}

export const cpaTransactionCodeCategoryPreauthorizedContinued: CPACodeCategory = {
  cpaCodeMin: '330',
  cpaCodeMax: '599',
  cpaCodeCategory: 'Pre-Authorized Transactions'
}
